...
fn main() {
    ...
    transcript.append_message(b"Message one: some data");
    let challenge1 = transcript.get_challenge();
    println!("Challenge 1: {:x?}", challenge1);

    transcript.append_message(b"Message two: more data");
    let challenge2 = transcript.get_challenge();
    println!("Challenge 2: {:x?}", challenge2);
}
